module.exports = nativeDescription: "slovenčina", englishDescription: "Slovak", translation:
  ...
  new_home:
    ...
    perform_at_higher_level: "umožňujú im dosiahnuť vyššie výkony."
    feedback: "Hry poskytujú spätnú väzbu v reálnom čase, čo umožňuje študentom upraviť svoje riešenie a pochopiť koncepty holisticky a nielen sa orientovať na správne a nesprávne odpovede."
    real_game: "Reálna hra, reálne programovanie."
    great_game: "Skvelá hra je hra viac ako medaile a dosiahnutý pokrok - je o ceste, primeraných rébusoch, ktoré máš šancu vyriešiť."
    ...
    request_demo_title: "Začni so svojimi študentmi už dnes!"
    ...
    view_my_classes: "Prehľad mojich tried"
    ...
    teachers: "Učitelia!"
    teachers_and_educators: "Učitelia & lektori"
#   class_in_box: "Learn how our classroom-in-a-box platform fits into your curriculum."
    get_started: "Začni"
    students: "Študenti:"
    join_class: "Pridaj sa k triede"
    role: "Tvoja rola:"
    student_count: "Počet študentov:"
    start_playing_for_free: "Začni hrať zadarmo!"
    students_and_players: "Študenti a hráči"
    goto_classes: "Choď na Moje triedy" # {change}
    educator_wiki: "Vzdelácia stránka wiki"
    view_profile: "Zobraziť Môj profil"
    view_progress: "Zobraziť Pokrok"
    login_switch: "Máš účet?"
    check_out_wiki: "Prezri si naše nové vzdelávacie stránky wiki"
    want_coco: "Chceš CodeCombat na tvojej škole?"
    form_select_role: "Vyber tvoju primárnu rolu"
    form_select_range: "Vyber veľkosť triedy"
  ...
  nav:
    ...
    support: "Podpora"
    faqs: "FAQs"
    help_pref: "Potrebuješ pomoc? E-mail"
  ...
  diplomat_suggestion:
    ...
    missing_translations: "Kým nebude všetko preložené do slovenčiny, budú nepreložené časti do slovenčiny dostupné v angličtine."
...
#    required_field: "Required field"
  ...
  play_level:
    ...
    victory_no_progress_for_teachers: "Pokrok sa neukladá pre učiteľov. Ale ak chcete, môžete si pre seba pridať študentský účet k svojej triede."
    title: "Návod"
  ...
  subscribe:
    ...
    unlock_help_videos: "Predplať si Codecombat a získaj prístup k videonávodom."
    ...
    currently_free: "Nemáš zaplatené predplatné"
    currently_free_until: "V súčasnej dobe máte predplatné, kým"
    was_free_until: "Mali ste bezplatné predplatné do"
#    managed_subs: "Managed Subscriptions"
#    subscribing: "Subscribing..."
    current_recipients: "Aktuálny príjemcovia"
...
#    using_prepaid: "Using prepaid code for monthly subscription"
  ...
  choose_hero:
    ...
    attack: "Útok" # Can also translate as "Attack"
    health: "Zdravie"
    speed: "Rýchlosť"
    ...
    backstab: "Bodnutie do chrbta" # As in "this dagger does this much backstab damage"
    skills: "Schopnosti"
  ...
  options:
    ...
    editor_config_behaviors_description: "Automaticky doplňuje hranaté a oblé zátvorky a uvodzovky."

  about:
    main_title: "Ak sa chceš naučiť programovať, musíš (veľa) kódovať."
    main_description: "Tvojou úlohou v CodeCombat je byť si istý, že to robíš s úsmevom na tvári."
    mission_link: "Misia"
    team_link: "Tím"
    community_link: "Komunita"
    story_link: "Príbeh"
    careers_link: "Kariéra"
    press_link: "Tlač"
    mission_title: "Naša misia: urobiť programovanie prístupné pre každého študenta na Zemi."
    mission_description_1: "<strong>Programovanie je mágia</strong>. Je to schopnosť tvoriť veci z čistej predstavivosti. Začali sme s CodeCombat aby sme dali učiacim sa ten pocit magickej sily ich končekov prstov používaním <strong>písaného kódu</strong>."
    mission_description_2: "Ako sa ukázalo, umožňuje im to učiť sa rýchlejšie. OMNOHO rýchlešie. Je to ako mať konverzáciu namiesto čítania manuálu. Chceme doniesť tento rozhovor na každú školu a ku <strong>každému študentovi</strong>, pretože by mal mať každý šancu učiť sa mágii programovania."
    team_title: "Predstavujeme tím CodeCombat"
    team_values: "Vážime si otvorený dialóg s rešpektom, kde vyhráva najlepšia myšlienka. Naše rozhodnutia sú založené na výskume zákazníka a náš proces je zameraný na poskytovanie hmatateľných výsledkov pre našich zákozníkov. Každý je nadšený, od nášho CEO až k našim GitHub prispievateľom, pretože si vážime rast a učenie v našom tíme."
    ...
    maka_title: "Zákaznícky advokát"
    maka_blurb: "Rozprávač príbehu"
    rob_title: "Software inžinier"
    rob_blurb: "Codes things and stuff"
    josh_c_title: "Dizajnér hier"
    josh_c_blurb: "Navrhuje hry"
    robin_title: "UX Dizajn & Výskum"
    robin_blurb: "Lešenie"
    ...
    jose_title: "Hudba"
    jose_blurb: "Vzlet"
    community_title: "...a naša open-source komunita"
    community_subtitle: "Viac ako 450 prispievateľov pomohlo budovať CodeCombat, a ďalší sa pripájajú týždenne!"
    community_description_1: "CodeCombat je komunitný projekt, so stovkami hráčov dobrovoľne vytvárajúcich úrovne, prispievajúcich k nášmu kódu pridávaním funkcií, opravovaním chýb, testovaním hry a dokonca aj prekladaním do 50 jazykov – zatiaľ. Zamestnanci, prispievatelia a web stránka sa obohacujú zdieľaním nápadov a spájaním úsilia, rovnako ako aj open source komunita vo všeobecnosti. Táto stránka je postavená na mnohých open source projektoch a sme otvorený tento zdroj vrátiť komunite a poskytovať kód-zvedavým hráčom známy projekt k preskúmaniu a k experimentovaniu. Každý sa môže pripojiť ku komunite CodeCombat! Pozrite sa na našu"
    community_description_link: "prispievateľskú stránku"
    community_description_2: "pre viac informácií."
    number_contributors: "Viac ako 450 prispievateľov pridalo ich podporu a čas k tomuto projektu."
    story_title: "Náš príbeh - zatiaľ"
    story_subtitle: "Od roku 2013 sa CodeCombat rozástol od jednoduchej sady skíc až po žijúcu a prospievajúcu hru.
    story_statistic_1a: "5,000,000+"
    story_statistic_1b: "hráčov celkovo"
    story_statistic_1c: "začalo svoju programátorskú cestu cez CodeCombat"
    story_statistic_2a: "Boli sme preložení do viac ako 50 jazykov  — naši hráči pochádzajú z"
    story_statistic_2b: "200+ krajín"
    story_statistic_3a: "Spoločne napísali"
    story_statistic_3b: "1 milión riadkov kódu a ten počet stále narastá"
    story_statistic_3c: "cez šesť rôznych programovacích jazykov"
    story_long_way_1: "Aj keď sme prešli dlhú cestu..."
    story_sketch_caption: "Nickova úplne prvá skica znázorňujúca programovanú hru v akcii."
    story_long_way_2: "stále máme čo robiť kým dokončíme našu úlohu, takže ..."
    jobs_title: "Poď pracovať s nami a pomôž písať históriu CodeCombatu!"
...
#    location_title: "We're located in downtown SF:"
  ...
  teachers:
    who_for_title: "Pre koho je určený CodeCombat?"
...
#    social_slack: "Chat with us in the public CodeCombat Slack channel"
  ...
  klany:
    klan: "Klan"
    klany: "Klany"
    nové_meno: "Meno nového klanu"
    nový_popis: "Popis nového klanu"
...
#    games_in_queue: "Games currently in the queue:"
    ...
    summary_wins: ", počet výhier "
    summary_losses: "počet prehier "
